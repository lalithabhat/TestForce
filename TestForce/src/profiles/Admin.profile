...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    <applicationVisibilities>
        <application>Visual_Test_Coverage_Tool</application>
    ...
    <classAccesses>
        <apexClass>CodeCoverageController</apexClass>
    ...
    <classAccesses>
        <apexClass>PerfLogController</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>PerfLogControllerTest</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>TestCodeCoverageController</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>Performance_Log_Parameter__c.Name__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Performance_Log_Parameter__c.Value__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Performance_Log__c.Page_Generation_Time__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Performance_Log__c.Page_Name__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Performance_Log__c.Query__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Performance_Log__c.Record_ID__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Performance_Log__c.Requesting_User__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <layoutAssignments>
        <layout>Performance_Log_Parameter__c-Performance Log Parameter Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Performance_Log__c-Performance Log Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <objectPermissions>
        ...
        <allowRead>true</allowRead>
        <modifyAllRecords>true</modifyAllRecords>
        <object>Performance_Log_Parameter__c</object>
        <viewAllRecords>true</viewAllRecords>
    </objectPermissions>
    <objectPermissions>
        <allowCreate>true</allowCreate>
        ...
        <allowRead>true</allowRead>
        <modifyAllRecords>true</modifyAllRecords>
        <object>Performance_Log__c</object>
        <viewAllRecords>true</viewAllRecords>
    </objectPermissions>
    <objectPermissions>
        <allowCreate>true</allowCreate>
    ...
    <pageAccesses>
        <apexPage>Code_Body</apexPage>
        <enabled>true</enabled>
    </pageAccesses>
    <pageAccesses>
        <apexPage>Code_Coverage</apexPage>
        <enabled>true</enabled>
    </pageAccesses>
    <pageAccesses>
        <apexPage>PerfLog</apexPage>
        <enabled>true</enabled>
    </pageAccesses>
